(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
	...
	var NinePatchCache = (function () {
		...
		*/
		...
		function NinePatchCache(game, imageKey, imageFrame, left, right, top, bottom) {
			...
			// School Zone - Fix checking value of PIXI.BaseTextureCache when it's not defined
			this.baseTexture = typeof PIXI.BaseTextureCache == 'object' && PIXI.BaseTextureCache[imageKey] ? PIXI.BaseTextureCache[imageKey] : imageCache.base;
			// End School Zone
			// this.baseTexture = imageCache.base;
	...
	*/
	...
	var NinePatchImage = (function (_Phaser$Image) {
		...
		* @param {String} strTint = Color to tint the NinePatchImage Ex: "D79FFF" (SZ Modified)
		*/

		function NinePatchImage(game, x, y, key, ninePatchImages, strTint) { /*** SZ Modified ***/
			if (x === undefined) x = 0;
			if (y === undefined) y = 0;
			...
			/*** SZ Modified ***/
			if(strTint != undefined)
			this.tintNineSlice(strTint);
		...
		_createClass(NinePatchImage, [
			{
				...
				value: function UpdateImageSizes() {
					...
					//SZ Modified - Update the bounds to match the new measures
					this.targetBounds = new Phaser.Rectangle(
						this.x - (this.targetWidth * anchor.x),
						this.y - (this.targetHeight * anchor.y),
						this.targetWidth,
						this.targetHeight
					);
			...
			{ /*** SZ Modified - Tint each slice using the provided color ***/
				key: 'tintNineSlice',
				value: function tintNineSlice(strTint) {
					this.images.forEach(function(arr){
						arr.forEach(function(image){
							image.tint = "0x" + strTint;
						});
					});
				}
			}
